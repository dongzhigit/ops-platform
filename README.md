...
当前仓库正在建设私有化智能运维平台，开发中的预发布版本为 `ops-v0.1.0-alpha.2`（基于 OpenSpug v3.4.0）。本版本已完成安全工程基线、M1 资产凭据/身份/对象授权，以及高风险操作审批与防篡改审计的后端纵向链路；审批管理前端、RDP/VNC、完整可观测性、知识库和 AI 闭环尚未完成。
