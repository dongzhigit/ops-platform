...
Django settings for ops-platform project.
...
ASGI_APPLICATION = 'ops_platform.routing.application'
...
TOKEN_TTL = 8 * 3600
SCHEDULE_KEY = 'ops-platform:schedule'
SCHEDULE_WORKER_KEY = 'ops-platform:schedule:worker'
MONITOR_KEY = 'ops-platform:monitor'
MONITOR_WORKER_KEY = 'ops-platform:monitor:worker'
EXEC_WORKER_KEY = 'ops-platform:exec:worker'
REQUEST_KEY = 'ops-platform:request'
BUILD_KEY = 'ops-platform:build'
...
SPUG_VERSION = 'v3.4.0'
OPS_PLATFORM_VERSION = os.environ.get('OPS_PLATFORM_VERSION', '0.1.0-alpha.41')

# override default config
try:
    from ops_platform.overrides import *
except ImportError:
    pass
