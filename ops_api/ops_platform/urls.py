"""ops-platform URL Configuration
...
urlpatterns = [
    ...
    path('v1/topology/', include('apps.topology.urls')),
    path('v1/knowledge/', include('apps.knowledge.urls')),
    path('v1/aiops/', include('apps.aiops.urls')),
    path('v1/incidents/', include('apps.incident.urls')),
