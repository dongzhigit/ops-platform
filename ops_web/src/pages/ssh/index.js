...
function WebSSH(props) {
  ...
  useEffect(() => {
    window.document.title = 'ops-platform web terminal'
  ...
  const ops_web_terminal =
    '   ____                  ____  __        __  ____                         \n' +
    '  / __ \\ ____   _____   / __ \\ \\ \\      / / / __ \\ ____   _____ _____    \n' +
    ' / / / // __ \\ / ___/  / /_/ /  \\ \\ /\\ / / / / / // __ \\ / ___// ___/    \n' +
    '/ /_/ // /_/ /(__  )  / ____/    \\ V  V / / /_/ // /_/ // /   (__  )     \n' +
    '\\____// .___//____/  /_/          \\_/\\_/  \\____// .___//_/   /____/      \n' +
    '     /_/                                        /_/                       \n' +
    '                 ops-platform web terminal                                \n'
    ...
    <div className={styles.container} onMouseUp={() => posX = 0} onMouseMove={handleMouseMove}>
      <div className={styles.sider} style={{width}}>
        <a className={styles.logo} href="/host" target="_blank">
          <img className={styles.logoIcon} src="/logo.svg?v=ops-platform-20260902" alt="ops-platform"/>
          <span className={styles.logoText}>ops-platform</span>
        </a>
      ...
      <div className={styles.content}>
        ...
        {hosts.length === 0 && (
          <pre className={sshMode ? styles.fig : styles.fig2}>{ops_web_terminal}</pre>
        )}
      </div>
      <Drawer
        title="文件管理器"
